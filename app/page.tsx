...
export default async function HomePage() {
  ...
  return (
    <AppLayout user={user}>
      <div className="flex flex-col h-[calc(100dvh-4rem)] md:h-auto space-y-0 md:space-y-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-3 md:grid-rows-1 grid-rows-[2fr_2fr_1fr] flex-1 md:flex-none pb-3 md:pb-0">
          <HomeCard
            title="Artifacts"
